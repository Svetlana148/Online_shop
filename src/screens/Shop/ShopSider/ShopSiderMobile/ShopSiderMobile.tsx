...
import { FilterSizeType, FilterSortType, selectFilterCategoryId, selectFilterSize, selectFilterSort, setFilterCategoryId, setFilterSize, setFilterSort } from "../../../../features/ShopSlice";
...
const ShopSiderMobile: React.FC<PropsType> = (props) => {
	...
	const onClickSort: MenuProps['onClick'] = (e) => {
		dispatch(setFilterSort(e.key as FilterSortType));
	};
